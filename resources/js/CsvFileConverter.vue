    ...
    <div class="csv_file_container" style="">
        ...
        <!-- File Upload section -->
            ...
            <div v-else class="mt-5 ">
                ...
                <div v-if="owners.length > 0" class="d-flex flex-row w-100 flex-wrap mt-3 justify-content-center"> 
                    
                    <div  v-for="owner in owners"  class="col-md-4 mb-2 mr-2" style="width:31%; margin-right:1%">
